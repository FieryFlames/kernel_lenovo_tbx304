...
static void gtp_pen_init(struct goodix_ts_data *ts)
{
    ...
    input_set_abs_params(ts->pen_dev, ABS_MT_POSITION_X, 0, ts->abs_x_max, 0, 0);//ts->abs_x_max
    input_set_abs_params(ts->pen_dev, ABS_MT_POSITION_Y, 0, ts->abs_y_max, 0, 0);  //ts->abs_y_max
