...
static void msm_otg_notify_charger(struct msm_otg *motg, unsigned mA)
{
	...
	dev_dbg(motg->phy.dev, "Requested curr from USB1 = %u, max-type-c:%u\n",
	...
	dev_dbg(motg->phy.dev, "Avail curr from USB1 = %u\n", mA);
...
static void msm_otg_chg_check_timer_func(unsigned long data)
{
	...
	// Bill Todo , workaround for unstandard charger 20161111
